    ...
    def bondObj():
        ...
        for stair in stairsData:
            ...
            for door in doorsData:
                ...
                if (inEdgeXYZ(stairPoints['X'], stairPoints['Y'], stairPoints['Z'],
                              doorPoints['X'], doorPoints['Y'], doorPoints['Z'],
                              door['SizeZ'])):
        ...
        for elevetion in levelData:
            ...
            for idx in range(len(BuildElement)):
                try:
                    ...
                    continue
            level.append({
                'Name': elevetion['levelName'],
                'SizeZ': elevetion['levelZ'] / 1000,
                'BuildElement': tempLevel
            })
        # pprint(level)
